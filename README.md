...
**Landing page:** <https://humanclarityinstitute.com/datasets/ai-decision-dependence-cognitive-caution-2025/>  
**Data summary:** <https://humanclarityinstitute.com/data/ai-decision-dependence-cognitive-caution-data-summary/>  
**Dashboard:** https://humanclarityinstitute.com/data-dashboard/

Part of the Human Clarity Institute’s **AI–Human Experience Data Series**, documenting how AI use shapes decision-making, confidence in personal judgement, reliance behaviours, and the mental load of navigating AI-assisted choices.
...
**Purpose:**  
To measure how adults experience AI-assisted decision-making, including reliance, self-doubt, perceived clarity, confidence shifts, and cognitive caution when interacting with AI systems.

**Scope:**  
Adults aged 18+, across six English-speaking countries.  
Data collected December 2025 via Prolific.  
Final sample size: **n = 201**.

**Themes:**  
AI reliance, decision-making confidence, second-guessing, persuasion, clarity, cognitive influence, mental load, behavioural dependence, digital decision friction.

**Outputs:**  
Likert-style numeric scores (1–7), open-text reflections, demographic variables, and AI tool usage patterns.
...
- **Files included:**  
  - AI-decision_dependence_cognitive_caution_clean20251201.csv  
  - AI-decision_dependence_cognitive_caution_raw20251201.csv  
  - AI-decision_dependence_cognitive_caution_2025_data_dictionary.csv  
  - README.md  
  - sha256.txt
...
AI decision-making, cognitive caution, judgement confidence, reliance on AI, digital clarity, decision offloading, persuasive AI, digital life, human–AI interaction, behavioural influence.
...
1 × open-text decision reflection  
Full demographic spine (age group, gender, education, work status, country, AI-tools use, hours online).
...
`AI-decision-dependence-cognitive-caution_2025_data_dictionary.csv`
